...
export class Sidebar {
  ...
  sidebarOptions: SidebarOption[] = [
    ...
    },
    {
      ...
      icon: '<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H15.75c.621 0 1.125.504 1.125 1.125v.375m0 0a2.25 2.25 0 002.25 2.25V4.5h.75a.75.75 0 00.75-.75v-.75h1.125c.621 0 1.125.504 1.125 1.125v5.25c0 .621-.504 1.125-1.125 1.125h-6.75a1.125 1.125 0 01-1.125-1.125V10.5H3.75v8.25" />'
    },
  ];
